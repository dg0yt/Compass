...
import org.openorienteering.compass.preference.PreferenceConstants
...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>(PreferenceConstants.VERSION)?.summaryProvider =
            SummaryProvider<Preference> { _root_ide_package_.org.openorienteering.compass.BuildConfig.VERSION_NAME }
